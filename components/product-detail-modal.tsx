  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl rounded-2xl bg-white shadow-2xl">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-gray-900">
                        ...
                        {isBest && (
                          <span className="ml-2 rounded bg-green-600 px-1.5 py-0.5 text-[9px] font-bold uppercase text-white">
                            Bester Preis
                          </span>
                        )}
                      </p>
        ...
        {/* Alert CTA */}
        <div className="rounded-b-2xl border-t border-gray-100 bg-gray-50 px-5 py-4 sm:px-6">
          <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-4 py-2 text-xs font-semibold text-gray-700 transition hover:border-red-300 hover:text-red-600">
