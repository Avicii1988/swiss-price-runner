      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl">
        ...
        <div className="mt-4">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 active:scale-[0.98] disabled:cursor-wait disabled:opacity-60"
          >
            {googleLoading ? (
